...
$(function() {
    ...
    if ($('#instafeed').length) {
        ...
        if (ig_user == user_pacehold || ig_access_token == access_pacehold || ig_cliet_id == client_pacehold) {
            $('#instafeed').php('<div style="background:#FCFCFC; padding:70px 20px; text-align:center;"><p style="max-width:500px; margin:0 auto;">To display Instagram Photos, Please add your username, access token and client id in the HTML.<p><div>')
        } else {
    ...
    $("#intro3 .home").vegas({
        slides: [{
            src: "views/img/fullImages/pic1.jpg"
        }, {
            src: "views/img/fullImages/pic2.jpg"
        }, {
            src: "views/img/fullImages/pic3.jpg"
        }]
    });
