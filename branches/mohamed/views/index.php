...
<section class="home">
    <div class="tittle-block">
        ...
        <h2>flight burger is a delitious restaurant website template</h2>
    </div>
    <div class="scroll-down">
        <a href="#about">
            <img src="views/img/arrow-down.png" alt="down-arrow">
        </a>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="page-header wow fadeInDown">
                    <h1>Flight Burger<small>A little about us and a breif history of how we started.</small></h1>
                </div>
            </div>
        </div>
        <div class="row wow fadeInUp">
                    ...
                    <div class="row">
                        <div class="col-xs-12 hidden-sm about-photo">
                            <div class="image-thumb">
                                <img src="views/img/thumb1.png" data-mfp-src="views/img/fullImages/pic1.jpg" class="img-responsive" alt="logo">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 about-photo hidden-xs">
                            <img src="views/img/thumb2.png" data-mfp-src="views/img/fullImages/pic2.jpg" class="img-responsive" alt="logo">
                        </div>
                        <div class="col-sm-6 about-photo hidden-xs">
                            <img src="views/img/thumb3.png" data-mfp-src="views/img/fullImages/pic3.jpg" class="img-responsive" alt="logo">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-8">
                ...
                <img src="views/img/signature.png" alt="signature">
            </div>
        </div>
    </div>
</section>
...
<section class="special">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="page-header wow fadeInDown">
                    <h1 class="white">today's specials<small>Today's Desert</small></h1>
                </div>
            </div>
        </div>
        <div class="row wow fadeInUp">
            <div class="col-md-offset-1 col-md-10">
                <div class="flexslider special-slider">
                    <ul class="slides">
                        <li>
                            <div class="slider-img">
                                <img src="views/img/thumb4.png" alt="" />
                            </div>
                            <div class="slider-content">
                                ...
                                <a class="btn btn-default" href="?controller=Home&action=Index" role="button">Order now</a>
                                <a class="btn btn-secondary" href="?controller=Home&action=Index" role="button">Add to cart</a>
                            </div>
                        </li>
                        <li>
                            <div class="slider-img">
                    ...
                    <div class="direction-nav hidden-sm">
                        <div class="next">
                            <a><img src="views/img/right-arrow.png" alt="" /></a>
                        </div>
                        <div class="prev">
                            <a><img src="views/img/left-arrow.png" alt="" /></a>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="reservation">
    <div class="container">
        ...
        <div class="reservation-footer">
            <p>You can also call: <strong>+216 99301654 </strong> to make a reservation.</p>
            <span></span>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row wow fadeInUp">
            <div class="col-md-4 col-sm-6">
                <div class="features-tile">
                    <div class="features-img">
                        <img src="views/img/thumb5.png" alt="" />
                    </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="features-tile">
                    <div class="features-img">
                        <img src="views/img/thumb6.png" alt="" />
                    </div>
                    <div class="features-content">
                        <div class="page-header">
                            <h1>Serving with love</h1>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="features-tile">
                    <div class="features-img">
                        <img src="views/img/thumb7.png" alt="" />
                    </div>
                    <div class="features-content">
                        <div class="page-header">
                            <h1>Serving with love</h1>
    ...
    <div class="container">
        ...
        <div class="food-menu wow fadeInUp">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="menu-btn">
                        <a class="btn btn-default btn-lg" href="./menu_all?controller=Home&action=Index&page=menu.php" role="button">Explore our menu</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row wow fadeInUp">
            <div class="col-md-12">
                <div class="trusted-sponsors">
                    <div class="item">
                        <a href="?controller=Home&action=Index">
                            <img src="views/img/sponsor/foodsquare.png" alt="sponsors">
                        </a>
                    </div>
                    <div class="item">
                        <a href="?controller=Home&action=Index">
                            <img src="views/img/sponsor/opentable.png" alt="sponsors">
                        </a>
                    </div>
                    <div class="item">
                        <a href="?controller=Home&action=Index">
                            <img src="views/img/sponsor/tripadvisor.png" alt="sponsors">
                        </a>
                    </div>
                    <div class="item">
                        <a href="?controller=Home&action=Index">
                            <img src="views/img/sponsor/zomato.png" alt="sponsors">
                        </a>
                    </div>
                    <div class="item">
                        <a href="?controller=Home&action=Index">
            ...
            <div class="row">
                <div class="col-md-offset-1 col-md-10">
                    <div class="trusted-slider">
                        <ul class="slides">
                            <li>
                                <img src="views/img/quote.png" alt="quote">
