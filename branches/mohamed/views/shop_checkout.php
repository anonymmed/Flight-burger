            ...
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="payment-method">
                    ...
                    <form class="text-center">
                        <input name="checkboxG2" id="checkboxG2" class="css-checkbox" type="checkbox"><span>I've read and accept the <a href="?controller=Home&action=Index&page=?controller=Home&action=Index&page=index.php">terms &amp; conditions</a></span>
                    </form>

                    <div class="text-center top-space-lg"><a href="?controller=Home&action=Index&page=?controller=Home&action=Index&page=shop_account_detail.php" class="btn btn-default btn-lg">Pay Now</a></div>
                </div>
            </div>
        </div>
    </div>
