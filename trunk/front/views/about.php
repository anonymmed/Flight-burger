...
<section class="about2">
    <div class="container">
        <div class="row wow fadeInUp">
            <div class="col-md-5">
                <img src="views/img/about.png" class="img-responsive" alt="" />
            </div>
            ...
            <div class="col-md-12">
                <div class="services-slider wow fadeIn">
                    <div class="service-content text-center">
                        <img src="views/img/ico1.png" class="center-block" alt="" />
                        <h4 class="text-uppercase">Birthday Party</h4>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
                    </div>
                    <div class="service-content text-center">
                        <img src="views/img/ico2.png" class="center-block" alt="" />
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 text-center">
                <div class="team-staff wow fadeInUp" data-wow-delay="0.2s">
                    <img src="views/img/team/1.png" class="img-responsive center-block" alt="" />
                    <h4>Enter Name Here</h4>
                    <p>Designation here</p>
                    <ul class="team-social">
                        <li><a href="?controller=Home&action=Index&page=http://www.facebook.com"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="?controller=Home&action=Index&page=http://www.twitter.com"><i class="fa fa-twitter"></i></a></li>
                        <li><a href="?controller=Home&action=Index&page=http://plus.google.com"><i class="fa fa-google-plus"></i></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 text-center">
                <div class="team-staff wow fadeInUp" data-wow-delay="0.4s">
                    <img src="views/img/team/2.png" class="img-responsive center-block" alt="" />
                    <h4>Enter Name Here</h4>
                    <p>Designation here</p>
                    <ul class="team-social">
                        <li><a href="?controller=Home&action=Index&page=http://www.facebook.com"><i class="fa fa-facebook"></i></a></li>
            ...
            <div class="col-md-3 col-sm-6 text-center">
                <div class="team-staff wow fadeInUp" data-wow-delay="0.6s">
                    <img src="views/img/team/3.png" class="img-responsive center-block" alt="" />
                    <h4>Enter Name Here</h4>
                    <p>Designation here</p>
                    <ul class="team-social">
                        <li><a href="?controller=Home&action=Index&page=http://www.facebook.com"><i class="fa fa-facebook"></i></a></li>
            ...
            <div class="col-md-3 col-sm-6 text-center">
                <div class="team-staff wow fadeInUp" data-wow-delay="0.8s">
                    <img src="views/img/team/4.png" class="img-responsive center-block" alt="" />
                    <h4>Enter Name Here</h4>
                    <p>Designation here</p>
                    <ul class="team-social">
                        <li><a href="?controller=Home&action=Index&page=http://www.facebook.com"><i class="fa fa-facebook"></i></a></li>
    ...
    <div class="container">
        ...
        <div class="food-menu wow fadeInUp">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="menu-btn">
                        <a class="btn btn-default btn-lg" href="?controller=Home&action=Index&page=menu_all.php" role="button">Explore our menu</a>
                    </div>
                </div>
            </div>
        </div>
