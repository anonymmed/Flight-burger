...
<title>Integral | Detailed View</title>
<!-- Site favicon -->
		...
		<div class="col-lg-12">
			...
			<div class="tab-wrapper clearfix">
				<ul class="nav nav-pills nav-pulls-default pull-left">
				  ...
				  <li class="active" role="presentation"><a href="detailed-view-2.html">STYLE 3</a></li>
				</ul>
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6">
							...
							<div class="card">
								...
								<!-- Card header -->
								<div class="card-header card-cover" style="background-image:url(images/mike.jpg);">
								...
								<div class="card-content">
									<p class="badges"><span class="badge badge-bordered">8 Albums</span><span class="badge badge-bordered">32 Songs</span></p>
									...
									<ul class="list-inline">
										<li><a href="#/" class="btn btn-primary btn-sm">Modify</a></li>
										<li><a href="#/" class="btn btn-danger btn-outline btn-sm">Delete</a></li>
									</ul>
								</div>
								<!-- /card content -->
							</div>
