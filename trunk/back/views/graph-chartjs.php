  ...
  <div class="main-container">
      ...
      ?>		<!-- /main header -->
		...
		<div class="main-content">
			<h1 class="page-title">ChartsJs</h1>
			<!-- Breadcrumb -->
			<ol class="breadcrumb breadcrumb-2"> 
				<li><a href="index.html"><i class="fa fa-home"></i>Home</a></li> 
				<li><a href="graph-flot.html">Graphs</a></li> 
				<li class="active"><strong>Charts</strong></li> 
			</ol>
			<div class="row"> 
				<div class="col-lg-6"> 
					<!-- panel--> 
			...
			<div class="row"> 
				<div class="col-lg-6"> 
					<div class="panel panel-default">
						<div class="panel-heading clearfix"> 
							<h4 class="panel-title">Polar Area Chart Example</h4> 
							<ul class="panel-tool-options"> 
								<li class="dropdown">
									<a data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="false"><i class="icon-cog"></i></a>
									<ul class="dropdown-menu dropdown-menu-right">
...
<script src="plugins/chartjs/js/chartjs-script.js"></script>
<!--Loader Js-->
