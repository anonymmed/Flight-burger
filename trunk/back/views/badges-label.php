...
<title>Integral | Badges &amp; Labels</title>
<!-- Site favicon -->
  ...
  <div class="main-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li class="active"><strong>Badges &amp; Labels</strong></li> 
		</ol>
		<div class="row">
			<div class="col-lg-6">
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
						<h4 class="panel-title">Badges</h4>
					...
					<div class="panel-body">
						<p><span class="badge badge-default">Plain</span></p>
			...
			<div class="col-lg-6">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<p><span class="label label-secondary">Secondary</span></p>
