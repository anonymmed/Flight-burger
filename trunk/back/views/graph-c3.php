...
<title>Integral | C3 Charts</title>
<!-- Site favicon -->
...
<link href="plugins/c3/css/c3.min.css" rel="stylesheet">
...
<div class="page-container">
  ...
  <div class="main-container">
	...
	<div class="main-content">
		<h1 class="page-title">C3 Charts</h1>
		<!-- Breadcrumb -->
		<ol class="breadcrumb breadcrumb-2"> 
			<li><a href="index.html"><i class="fa fa-home"></i>Home</a></li> 
			<li><a href="graph-flot.html">Graphs</a></li> 
			<li class="active"><strong>C3 Charts</strong></li> 
		</ol>
		<div class="row"> 
			<div class="col-lg-6"> 
				<!-- panel--> 
		...
		<div class="row"> 
			<div class="col-lg-6"> 
				<div class="panel panel-default">
					<div class="panel-heading clearfix"> 
						<h4 class="panel-title">Radar Chart Example</h4> 
						<ul class="panel-tool-options"> 
							<li class="dropdown">
								<a data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="false"><i class="icon-cog"></i></a>
								<ul class="dropdown-menu dropdown-menu-right">
...
<!--C3 Charts-->
<script src="plugins/c3/js/d3.v3.min.js"></script>
<script src="plugins/c3/js/c3.min.js"></script>
<script src="plugins/c3/js/c3-script.js"></script>
<!--Loader Js-->
