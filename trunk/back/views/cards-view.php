...
<title>Integral | Cards View</title>
<!-- Site favicon -->
  ...
  <div class="main-container">
	...
	<div class="header-secondary row">
		<div class="col-lg-12">
			...
			<ol class="breadcrumb breadcrumb-2"> 
				...
				<li><a href="simple-view.html">List Views</a></li> 
				<li class="active"><strong>Users</strong></li> 
			</ol>
			<div class="tab-wrapper clearfix">
				<ul class="nav nav-pills nav-pulls-default pull-left">
				  <li role="presentation"><a href="simple-view.html">STYLE 1</a></li>
				  <li class="active" role="presentation"><a href="cards-view.html">STYLE 2</a></li>
				  <li role="presentation"><a href="table-view.html">STYLE 3</a></li>
				</ul>
    ...
    <div class="main-content">
		...
		<footer class="footer-main"> 
			&copy; 2016 <strong>Integral</strong> Admin Template by <a target="_blank" href="#/">G-axon</a>		</footer>	
		<!-- /footer -->
	  </div>
	  <!-- /main content -->
  </div>
