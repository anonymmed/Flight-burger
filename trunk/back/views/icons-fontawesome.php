...
<title>Integral | Font Awesome</title>
<!-- Site favicon -->
  ...
  <div class="main-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li class="active"><strong>Fontawesome</strong></li> 
		</ol>
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
						<h3 class="panel-title">New Icons in 4.5</h3>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
						<h3 class="panel-title">Hand Icons</h3>
						<ul class="panel-tool-options"> 
							<li><a data-rel="collapse" href="#"><i class="icon-down-open"></i></a></li>
							<li><a data-rel="reload" href="#"><i class="icon-arrows-ccw"></i></a></li>
							<li><a data-rel="close" href="#"><i class="icon-cancel"></i></a></li>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="alert alert-info">
							<button data-dismiss="alert" class="close" type="button"><span>×</span><span class="sr-only">Close</span></button><i class="fa fa-info-circle fa-lg"></i> These icons work great with the <code>.fa-spin</code> class.
						</div>
						<div class="row icons-showcase">
							<div class="col-md-3 col-sm-4"><i class="fa fa-circle-o-notch"></i> circle-o-notch</div>
							<div class="col-md-3 col-sm-4"><i class="fa fa-cog"></i> cog</div>
