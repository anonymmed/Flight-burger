...
<title>Integral | Progressbars</title>
<!-- Site favicon -->
  ...
  <div class="main-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li class="active"><strong>Progress Bars</strong></li> 
		</ol>
		<!-- Progress Bars -->	
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
						<h4 class="panel-title">Progress Types</h4>
					...
					<div class="panel-body collapse in" id="collapsepanel">
						<h5><strong>Basic ProgressBars</strong></h5>
						<div class="progress"> 
						...
						<hr>
						<h5><strong>Striped ProgressBars</strong></h5>
						<div class="progress">
						...
						<hr>
						<h5><strong>Active ProgressBar</strong></h5>
						...
						<hr>
						<h5><strong>Stacked Progressbars</strong></h5>
