...
<title>Integral | Flot Charts</title>
<!-- Site favicon -->
...
<!--[if lte IE 8]>
	<script type="text/javascript" src="plugins/flot/js/excanvas.min.js"></script>
<![endif]-->
		...
		<div class="main-content">
			...
			<div class="row"> 
				...
				<div class="col-lg-6"> 
					<div class="panel panel-default">
						<div class="panel-heading clearfix"> 
							<h4 class="panel-title">Live Chart Example</h4> 
							<ul class="panel-tool-options"> 
								<li class="dropdown">
									<a data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="false"><i class="icon-cog"></i></a>
									<ul class="dropdown-menu dropdown-menu-right">
						...
						<div class="panel-body"> 
							<div class="flot-chart">
								<div id="flot-live-chart-moving" class="flot-chart-content"></div>
							</div>	
						</div> 
					</div> 
				</div>
			...
			<div class="row"> 
				<div class="col-lg-12"> 
					<div class="panel panel-default">
						<div class="panel-heading clearfix"> 
							<h4 class="panel-title">Multiple Axes Line Chart Example</h4> 
							<ul class="panel-tool-options"> 
								<li class="dropdown">
									<a data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="false"><i class="icon-cog"></i></a>
									<ul class="dropdown-menu dropdown-menu-right">
...
<script src="plugins/flot/js/flot-script.js"></script>
<!--Loader Js-->
